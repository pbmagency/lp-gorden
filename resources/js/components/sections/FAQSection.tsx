            ...
            <SectionWrapper id="faq" bg="cultured" className="pt-20 md:pt-28 pb-12 md:pb-16">
                ...
                <div className="max-w-lg mx-auto text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center mb-1">
                        <LpButton href={waUrl('Halo Kak, saya mau tanya tentang program TOEFL Full Bright')} size="md" onClick={() => trackCTA('faq_primary', 'Mulai Belajar Sekarang', '#pricing')}>Mulai Belajar Sekarang →</LpButton>
