...
const faqs: { category: string; q: string; a: string; node?: ReactNode }[] = [
        ...
        node: (
            ...
            >
                <p className="mb-2.5" style={{ color: '#3d3d3d' }}>
                    Pilihan Jam Belajar (Pilih Salah Satunya)
                </p>
    ...
    },
    {
        ...
        a: 'Setelah mendaftar dan melakukan pembayaran, kamu akan mendapatkan email berisi link dan akun untuk masuk ke platform LMS Full Bright. Di sana tersedia video e-course, e-book, dan bank soal yang bisa diakses kapan saja selama 2 tahun. Rekaman ZOOM juga bisa diakses seumur hidup.',
    },
    {
    ...
    },
    {
        ...
        a: 'Sangat cocok! Kurikulum kami dirancang dari level dasar, lengkap dengan evaluasi progress mingguan dan strategi submission yang disesuaikan jurusanmu. Kamu tidak perlu memiliki grammar yang sempurna untuk memulai — instruktur kami akan membimbingmu langkah demi langkah sampai skor target submission-mu tercapai.',
    },
    {
        category: 'Metode & Efektivitas',
        q: 'Berapa kenaikan skor yang bisa saya harapkan dalam 15 hari?',
        a: 'Berdasarkan data alumni kami, rata-rata peningkatan berkisar 80–100 poin dalam 15 hari bagi yang mengikuti program secara konsisten. Kuncinya sederhana: hadir di setiap sesi dan kerjakan semua bank soal yang diberikan.',
    },
    {
        category: 'Untuk Orang Sibuk',
        q: 'Bagaimana jika saya sangat sibuk bekerja atau kuliah?',
        a: 'Kelas Full Bright dirancang compact: hanya 60 menit per hari. Rekaman ZOOM tersedia dan bisa diakses seumur hidup, sehingga kamu bisa menonton ulang kapan saja. Banyak alumni kami adalah dokter, PNS aktif, dan karyawan korporat yang berhasil dengan keterbatasan waktu mereka.',
    },
    {
        category: 'Pendaftaran & Pembayaran',
        q: 'Bagaimana cara mendaftar dan metode pembayaran apa saja?',
        a: 'Pendaftaran sangat mudah: klik tombol "Mulai Belajar Sekarang" atau "Bayar Sekarang", pilih paket yang sesuai, lalu selesaikan pembayaran. Setelah pembayaran berhasil, kamu akan mendapatkan email konfirmasi beserta akses ke LMS dan grup WhatsApp kelas. Pembayaran dapat dilakukan via transfer bank, GoPay, OVO, DANA, dan QRIS.',
    },
    {
        category: 'Jaminan & Garansi',
        q: 'Apa yang terjadi jika submission beasiswa saya butuh skor lebih tinggi dari yang dijanjikan?',
        a: 'Garansi sampai skor target tercapai berlaku khusus untuk Paket Bundling. Jika setelah mengikuti program secara penuh dan konsisten skor kamu belum mencapai target submission-mu, kamu bisa claim garansi dan mengulang kelas di batch berikutnya.',
    },
    {
        category: 'Pendaftaran & Pembayaran',
        q: 'Apa saja fasilitas yang didapat dan berapa harganya?',
        a: 'Kami menyediakan 3 paket: Starter (Rp 250.000) untuk 10 hari dengan target skor 450+, Intermediate (Rp 350.000) untuk 15 hari dengan target skor 500+, dan Bundling Starter + Intermediate (Rp 375.000) untuk 25 hari dengan target skor 500+ plus garansi mengulang. Setiap paket sudah termasuk LIVE ZOOM, rekaman, video materi, e-book, grup WA diskusi, placement test, post test, dan sertifikat TOEFL Prediction.',
    },
    {
        category: 'Metode & Efektivitas',
        q: 'Apakah ada batasan usia untuk mengikuti program ini?',
        a: 'Program Full Bright terbuka untuk peserta berusia 17 hingga 45 tahun. Cocok untuk pelajar, mahasiswa, fresh graduate, maupun karyawan yang ingin meningkatkan skor TOEFL untuk keperluan studi, karir, atau beasiswa.',
    },
    {
        category: 'Metode & Efektivitas',
        q: 'Apakah dijamin bisa mencapai skor 500?',
        a: 'Kami tidak bisa memberikan jaminan skor 500 secara mutlak karena hasil sangat tergantung pada kesungguhan dan konsistensi belajar masing-masing peserta. Yang bisa kami jamin: metode yang sudah terbukti pada 45.000+ alumni, materi yang fokus dan terstruktur, serta pendampingan penuh selama program. Peserta yang hadir konsisten dan mengerjakan semua latihan soal rata-rata mengalami kenaikan 80–100 poin dalam 15 hari.',
    },
];
...
const defaultOpen = new Set([
    ...
    'Apa yang terjadi jika submission beasiswa saya butuh skor lebih tinggi dari yang dijanjikan?',
]);
