...
import HeroSection from '@/components/sections/cycle7/angle-2/HeroSection';
...
const AgitationSection = lazy(
    () =>
        import('@/components/sections/cycle7/angle-2/AgitationSection'),
);
const ValueSection = lazy(
    () =>
        import('@/components/sections/cycle7/angle-2/ValueSection'),
);
const SocialProofSection = lazy(
    () =>
        import('@/components/sections/cycle7/angle-2/SocialProofSection'),
);
const PricingSection = lazy(
    () =>
        import('@/components/sections/cycle7/angle-1/PricingSection'),
);
