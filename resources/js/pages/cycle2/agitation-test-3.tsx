...
const AgitationSection = lazy(
    () => import('@/components/sections/cycle2-test-problem/AgitationSection3'),
);
...
export default function AgitationTest3() {
    ...
    return (
        <>
            <Head>
                <title>
                    Cycle 2 - AgitationSection 3 | Full Bright Indonesia
                </title>
                <meta
                    name="description"
                    content="Testing AgitationSection 3 variant"
                />
            </Head>
