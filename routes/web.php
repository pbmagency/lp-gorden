...
Route::inertia('/c2-problem-1', 'cycle2/agitation-test-1')->name('cycle2.agitation1');

Route::inertia('/c2-problem-2', 'cycle2/agitation-test-2')->name('cycle2.agitation2');

Route::inertia('/c2-problem-3', 'cycle2/agitation-test-3')->name('cycle2.agitation3');
